...
const Herosection = ({ heroTheme,onpage, }) => {
    ...
    <>
      ...
      >
        ...
        <SwiperSlide>
          ...
          <img src={displayDetails&&displayDetails.profilePic} alt="" className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-30 h-30 z-40 rounded-full object-cover shadow-neutral-400" />
        </div>
          {
          displayDetails && ( 
          ...
          <button className="button w-1/2 h-15 flex items-center justify-center gap-2 textbody font-serif" onClick={()=>onpage("Contact")}><i class="fa-solid fa-location-dot "></i> Contact me</button>
        </div>
          </div>
      </div>
    </>
